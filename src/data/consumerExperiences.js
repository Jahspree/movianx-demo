...
export const CREATOR_SPOTLIGHTS = [
  {
    ...
    year: "Demo",
    rights: "Movianx generated visual demo",
    sourceType: "Creator-safe spotlight concept",
    synopsis: "A curated director profile concept for future creator worlds and release collections.",
    ...
    merchCollections: [{ title: "Director Collection", description: "A future fan-support release for the creator's world.", label: "Support the creator" }],
    enhancements: ["Creator world profile", "Audience discovery", "Release collection foundation"],
  ...
  },
  {
    ...
    rights: "Movianx generated visual demo",
    sourceType: "Creator-safe spotlight concept",
    synopsis: "A creator profile concept for spatial sound artists and immersive audio directors.",
    ...
    merchCollections: [{ title: "Sound World Collection", description: "A future limited release connected to the artist's sound world.", label: "Support the artist" }],
    enhancements: ["Spatial audio profile", "Creator discovery", "Release collection foundation"],
  ...
  },
  {
    ...
    rights: "Movianx generated visual demo",
    sourceType: "Creator-safe spotlight concept",
    synopsis: "A creator profile concept for visually driven storytellers and experimental media artists.",
    ...
    merchCollections: [{ title: "Visual World Collection", description: "A future fan-support release for the creator's visual universe.", label: "From the creator collection" }],
    enhancements: ["Visual creator profile", "Audience discovery", "Release collection foundation"],
  ...
  },
  {
    ...
    rights: "Movianx generated visual demo",
    sourceType: "Creator-safe spotlight concept",
    synopsis: "A creator ecosystem preview for future films, stories, music, and immersive releases.",
    ...
    moodTags: ["premium", "curated", "future-facing"],
    styleTags: ["creator-first", "media platform", "premium"],
    merchCollections: [{ title: "Creator World Collection", description: "A future limited fan-support release connected to the creator ecosystem.", label: "Support the creator" }],
    enhancements: ["Creator universe profile", "Audience discovery", "Release collection foundation"],
...
export const CONSUMER_RAILS = [
  ...
  },
  {
    ...
    description: "Spatial listening concepts for artist worlds, memory, and cinematic atmosphere.",
    mood: "Spatial audio",
    accent: "#0f766e",

...
export const PERFORMANCE_SCRIPT = {
  ...
  ch0: [
    ...
    },
    {
      ...
      beatIndex: 1,
      textWithDirections: "<<whispering>> Did you hear that? <<breathless>> No. Listen. That wasn't nothing.",
      stability:   0.30,
      style:       0.65,
      speed:       0.86,
    ...
    },
    {
      ...
      beatIndex: 2,
      textWithDirections: "<<gasping>> Someone's in the house. <<breathless>> I heard glass downstairs. They're inside.",
      stability:   0.14,
      style:       0.86,
      speed:       0.88,
    ...
    },
    {
      ...
      beatIndex: 3,
      textWithDirections: "<<breathless>> I can hear them moving. More than one. <<whispering>> The bat's in the closet. My phone's dead. The kids are down the hall.",
      stability:   0.18,
      style:       0.80,
      speed:       0.84,
  ...
  ch1: [
    {
      ...
      beatIndex: 0,
      textWithDirections: "<<whispering>> They're coming up. The stairs. <<breathless>> I can hear them.",
      stability:   0.20,
      style:       0.80,
      speed:       0.88,
      similarity_boost: 0.82,
    ...
    },
    {
      beatId:    "ch1_upstairs",
      beatIndex: 1,
      textWithDirections: "<<breathless>> One step. Two. Three. <<whispering>> They stopped. <<breathless>> No. They're moving again.",
      stability:   0.12,
      style:       0.90,
      speed:       0.80,
      similarity_boost: 0.80,
    ...
    },
    {
      beatId:    "ch1_landing",
      beatIndex: 2,
      textWithDirections: "<<whispering>> The kids are right there. Three doors down. <<breathless>> He said something. He knows we're here.",
      stability:   0.08,
      style:       0.94,
      speed:       0.78,
    ...
    },
    {
      beatId:    "ch1_come_out",
      beatIndex: 3,
      textWithDirections: "<<whispering>> He's on the landing now. Same floor. <<breathless>> Same air. I can't think. What do we do? <<crying>> Please.",
      stability:   0.10,
      style:       0.92,
      speed:       0.82,
      similarity_boost: 0.80,
  ...
  ch2: [
    ...
    },
    {
      ...
      beatIndex: 2,
      textWithDirections: "<<panicked>> He said last chance. Whatever happens, protect the kids. <<breathless>> Promise me. Promise me.",
      stability:   0.05,
      style:       0.96,
      speed:       0.94,
    ...
    },
    {
      ...
      beatIndex: 3,
      textWithDirections: "<<breathless>> The handle is turning. Right now.",
      stability:   0.06,
      style:       0.95,
      speed:       0.90,
      similarity_boost: 0.76,
    ...
    },
    {
      ...
      beatIndex: 4,
      textWithDirections: "<<whispering>> Tell me. <<crying>> Please. I can't do this alone.",
      stability:   0.08,
      style:       0.92,
      speed:       0.80,
      similarity_boost: 0.80,
  ...
  ch3: [
    {
      ...
      beatIndex: 0,
      textWithDirections: "It's done. <<crying>> There was no right answer. There never was.",
      stability:   0.68,
      style:       0.18,
      speed:       0.84,
    ...
    },
    {
      ...
      beatIndex: 2,
      textWithDirections: "<<crying>> What did we become?",
      stability:   0.60,
      style:       0.20,
      speed:       0.76,
      similarity_boost: 0.88,

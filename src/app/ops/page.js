      ...
      <div className={styles.shell}>
        <header className={styles.header}>
          ...
          <aside className={styles.statusCard}>
            ...
            <p className={styles.muted}><Link href="/ops/dashboard">Executive dashboard</Link> · <Link href="/ops/recommendations">Recommendations</Link> · <Link href="/ops/uploads">Creator intake review</Link> · <Link href="/ops/system">System diagnostics</Link></p>
          </aside>
        </header>
